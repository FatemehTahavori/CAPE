...
def load_graph_mtx(project_dir, load_for_demo=False):
    ...
    if not load_for_demo:
        ...
        A = list(np.load(os.path.join(project_dir, 'data', 'transform_matrices/for_demo/A.npy'), encoding='latin1', allow_pickle=True))
        D = list(np.load(os.path.join(project_dir, 'data', 'transform_matrices/for_demo/D.npy'), encoding='latin1', allow_pickle=True))
        U = list(np.load(os.path.join(project_dir, 'data', 'transform_matrices/for_demo/U.npy'), encoding='latin1', allow_pickle=True))
